...
amtest <- list()
for (i in 1:4) {
  amtest[[i]] <- readRDS(paste0(sub("\\/train\\/", "", path[[i]]), "/allmat/fullmattest.rds"))
  #length(levels(as.factor(unlist(amtest[[i]][[2]]))))
  amtest[[i]][[3]] <- list(rep(i, length(amtest[[i]][[1]])))
}
testdatall <- list(c(amtest[[1]][[1]], amtest[[2]][[1]], amtest[[3]][[1]], amtest[[4]][[1]]),
  c(amtest[[1]][[2]], amtest[[2]][[2]], amtest[[3]][[2]], amtest[[4]][[2]]),
  c(amtest[[1]][[3]][[1]], amtest[[2]][[3]][[1]], amtest[[3]][[3]][[1]], amtest[[4]][[3]][[1]]))
...
amval <- list()
for (i in 1:4) {
  amval[[i]] <- readRDS(paste0(sub("\\/train\\/", "", path[[i]]), "/allmat/fullmatval.rds"))
  #length(levels(as.factor(unlist(amval[[i]][[2]]))))
  amval[[i]][[3]] <- list(rep(i, length(amval[[i]][[1]])))
}
valdatall <- list(c(amval[[1]][[1]], amval[[2]][[1]], amval[[3]][[1]], amval[[4]][[1]]),
  c(amval[[1]][[2]], amval[[2]][[2]], amval[[3]][[2]], amval[[4]][[2]]),
  c(amval[[1]][[3]][[1]], amval[[2]][[3]][[1]], amval[[3]][[3]][[1]], amval[[4]][[3]][[1]]))
cat(format(Sys.time(), "%F %R"), ": Saving\n")
...
amtrain <- list()
for (i in 1:4) {
  amtrain[[i]] <- readRDS(paste0(sub("\\/train\\/", "", path[[i]]), "/allmat/fullmattrain.rds"))
  #length(levels(as.factor(unlist(amtrain[[i]][[2]]))))
  amtrain[[i]][[3]] <- list(rep(i, length(amtrain[[i]][[1]])))
}
traindatall <- list(c(amtrain[[1]][[1]], amtrain[[2]][[1]], amtrain[[3]][[1]], amtrain[[4]][[1]]),
  c(amtrain[[1]][[2]], amtrain[[2]][[2]], amtrain[[3]][[2]], amtrain[[4]][[2]]),
  c(amtrain[[1]][[3]][[1]], amtrain[[2]][[3]][[1]], amtrain[[3]][[3]][[1]], amtrain[[4]][[3]][[1]]))
cat(format(Sys.time(), "%F %R"), ": Saving\n")
